...
int search(const CycList<int>& list, int value) 
{
    int comparisons = 0;
...
void printList(const CycList<int>& list) 
{
    if (list.isEmpty()) 
    {
...
int main() 
{
    ...
    // Generowanie losowych liczb i wstawianie do listy
