...
-- Types, procedures and functions
  ...
  Flags: array (0 .. Nr_Of_Processes-1) of Integer range 0 .. 1 := (others => 0);
  isTurn: Integer range 0 .. 1 := 0;

  pragma Volatile(Flags);
  pragma Volatile(isTurn);
  ...
  begin
    ...
    for Step in 0 .. Nr_of_Steps/4 - 1  loop  -- TEST !!!
      ...
      isTurn := Process.Id;
      loop
        exit when Flags(Other_Id) = 0 or isTurn /= Process.Id;
      end loop;
